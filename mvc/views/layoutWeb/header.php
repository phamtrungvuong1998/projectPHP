...
<div class="header w3-bar w3-black w3-card">
    ...
    <div class="w3-dropdown-hover w3-hide-small">
        <?php if (isset($_SESSION['login'])) { ?>
          ...
          <div class="w3-dropdown-content w3-bar-block w3-card-4">
            ...
            <h5 class="w3-bar-item"><a href="http://localhost:8080/Project_php_26/Login/logout">Đăng xuất</a></h5>

        <?php }else{ ?>
          <button class="w3-padding-large w3-button" title="More">ĐĂNG NHẬP/ĐĂNG KÝ <i class="fa fa-caret-down"></i></button>     
          <div class="w3-dropdown-content w3-bar-block w3-card-4">
            <a href="http://localhost:8080/Project_php_26/Login/" class="w3-bar-item w3-button">Đăng nhập</a>
    ...
    <form method="post" action="http://localhost:8080/Project_php_26/Web/search">
      <input type="search" name="search" style="float: right; margin-top: 20px;">
      <i style="float: right; margin-top: 20px;">Search </i>
    </form>
  </div>
